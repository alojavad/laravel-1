 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('') }}">Hightr</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <a href="{{ url ('admin/home') }}"><i class="fa fa-dashboard fa-fw"></i> Home</a>
                        </li>
                        <li {{ (Request::is('admin/visits/*') ? 'class="active"' : '') }}>
                        <a href="{{ url ('admin/visits') }}"><i class="fa fa-dashboard fa-fw"></i> Visits</a>
                        </li>
                        <li {{ (Request::is('admin/news/*') ? 'class="active"' : '') }}>
                        <a href="{{ url ('admin/news') }}"><i class="fa fa-dashboard fa-fw"></i> News<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li {{ (Request::is('admin/news') ? 'class="active"' : '') }}>
                            <a href="{{ url ('admin/news') }}">News</a>
                            </li>
                            <li {{ (Request::is('news/create') ? 'class="active"' : '') }}>
                            <a href="{{ url ('news/create') }}">Add News</a>
                            </li>
                            </ul>
                        </li>
                        <li {{ (Request::is('admin/comment/*') ? 'class="active"' : '') }}>
                        <a href="{{ url ('admin/comment') }}"><i class="fa fa-dashboard fa-fw"></i> Comment</a>
                        </li>
                        <li {{ (Request::is('admin/replay/*') ? 'class="active"' : '') }}>
                        <a href="{{ url ('admin/replay') }}"><i class="fa fa-dashboard fa-fw"></i> Replay</a>
                        </li>
                        <li {{ (Request::is('admin/tag/*') ? 'class="active"' : '') }}>
                        <a href="{{ url ('admin/tag') }}"><i class="fa fa-dashboard fa-fw"></i> Tag</a>
                        </li>
