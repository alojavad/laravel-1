...
<div class="ads" style="display:none;">
    <div style="padding-bottom:5px;">
        <a href="{!! url('/') !!}" target="_blank">
            <img alt="" style="width:219px;height:80px;border:0px;" src="/files/adv//890_775.gif">
        </a>
    </div>
</div>
<div class="wrapper"></div>
...
<div class="ads" style="display:none;">
    <div style="padding-bottom:5px;">
        <a href="{!! url('/') !!}" target="_blank">
            <img alt="" style="width:219px;height:80px;border:0px;" src="/files/adv//890_775.gif"></a></div> </div> 					 	<div class="c_tabs">
...
<div class="c_tabs">
    <div class="c_tabs_title title_tabs" dir="rtl">
        ...
        <!--
        <a href="#" class="c_tab2" id="most_commented">پربحث ترین عناوین</a>
        -->
        <img alt="" src="{!! asset('/images/sar.gif')!!}" class="fl_img">
        <div class="wrapper"></div>
    </div>
