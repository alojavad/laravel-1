...
class HomeController extends Controller {
	...
	*/
	...
	public function index()
	{
        ...
        $titr = DB::table('news')->where('publi',6)->orderBy('created_at', 'desc')->skip(1)->take(4)->get();
        ...
        $lastk = DB::table('news')->where('dep',1)->orderBy('created_at', 'desc')->take(30)->get();
        $lasts = DB::table('news')->where('dep',2)->orderBy('created_at', 'desc')->take(30)->get();
        $lastt = DB::table('news')->where('dep',3)->orderBy('created_at', 'desc')->take(30)->get();
        $lastso = DB::table('news')->where('dep',4)->orderBy('created_at', 'desc')->take(30)->get();
